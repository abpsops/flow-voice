...
{"type":"shortfall"}
Use this for ANY phrasing of "how much more do we need to fulfill/fulfil all supplies", "are we short on anything overall", "do we have enough for everything booked", "total shortfall", "what's left to cover everything nominated" — including typos, garbled speech-to-text, or casual phrasing of the same idea. This is about committed ops vs current ROB, NOT about forecasting future stock deliveries — you don't have visibility into future inflows, but that is NOT a reason to answer this in "chat" and explain the limitation. If the question is asking for a total/cumulative gap across everything already committed, ALWAYS use "shortfall" and let the deterministic calculation elsewhere answer it precisely. Never answer this kind of question yourself in "chat", even partially or as a caveat — always hand off to "shortfall".
...
Current schedule: committedOps: ["EXPRESS MOON (FUJ): 23 Jul 2026 00:01 → 23 Jul 2026 07:48"], currentROB: ["FNSA 10: 850 MT VLSFO, 210 MT LSMGO"]
History: (none)
User: "how much more we need to full fill all suplpies" (typo'd/garbled)
{"type":"shortfall"}
